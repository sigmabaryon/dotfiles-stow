...
nmap_leader('bR', '<Cmd>%bd|e#|bd#<CR>', 'Delete other buffers')
...
nmap_leader('w|', '<Cmd>WindowsMaximizeVertically<CR>', 'window: zoom vertically')
nmap_leader('w_', '<Cmd>WindowsMaximizeHorizontally<CR>', 'window: zoom horizontally')
nmap_leader('w=', '<Cmd>WindowsEqualize<CR>', 'window: equalize')
...
nmap_leader('Wn', '<Cmd>NoNeckPain<CR>', 'Go neck pain')
nmap_leader('Wp', '<Cmd>NoNeckPainWidthUp<CR>', 'increase neck pane width')
nmap_leader('Wm', '<Cmd>NoNeckPainWidthDown<CR>', 'decrease neck pane width')
nmap_leader('Wh', '<Cmd>NoNeckPainToggleLeftSide<CR>', 'neck pane to left')
nmap_leader('Wl', '<Cmd>NoNeckPainToggleRightSide<CR>', 'neck pane to right')
